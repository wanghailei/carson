...
- Before merge recommendation, run `butler review gate`; it enforces warm-up wait, unresolved-thread convergence, and `Codex:` dispositions for actionable top-level findings.
